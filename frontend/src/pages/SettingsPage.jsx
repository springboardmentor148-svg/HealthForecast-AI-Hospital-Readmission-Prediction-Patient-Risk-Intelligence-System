...
export function SettingsPage() {
  ...
  // Profile
  const [fullName, setFullName] = useState(user?.fullName || "Dr. Sarah Mitchell");
  const [email, setEmail] = useState(user?.email || "sarah.mitchell@healthforecastai.com");
            ...
            >
              <div className="panel-header-row">
                <div>
                  ...
                  <p>Manage how your activity and patient data are handled</p>
                </div>
              </div>
              ...
              <label className="settings-toggle-row">
                ...
                />
                <span>Allow anonymized data to be used for research analytics</span>
              </label>
              ...
              <label className="settings-toggle-row">
                ...
                />
                <span>Notify me when my account activity is reviewed</span>
              </label>

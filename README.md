...
> **Note:** This project is an academic/software decision-support system and is not intended to replace professional medical diagnosis or clinical judgment.
...
The machine-learning study includes both multiclass and binary readmission classification.

### Multiclass Classification

The three-class formulation predicts:
...
11. Balanced XGBoost
12. Balanced LightGBM
13. Hyperparameter-tuned XGBoost
14. Hyperparameter-tuned LightGBM
15. FLAML AutoML
16. Hybrid K-Means + XGBoost/LightGBM
...
The following benchmark results are based on the machine-learning evaluation documented for the project.
...
| Tuned XGBoost | Hyperparameter-Tuned | 58.96% | 55.88% | 58.96% | 54.44% |
...
| K-Means + XGBoost | Hybrid | 58.79% | 55.70% | 58.79% | 54.56% |
...
- Readmission prediction model integration
- FastAPI backend
...
- Patient frontend integration in progress
- Profile and application UI modules

Further work includes completing remaining frontend integrations, reports, settings, advanced analytics, and production deployment.
...
Add your preferred license file to the repository if the project is intended for public distribution.

...
export function mapPatientToUi(patient) {
  ...
  return {
    ...
    numberInpatient: patient.number_inpatient ?? null,
    numberEmergency: patient.number_emergency ?? null,
    numberOutpatient: patient.number_outpatient ?? null,
    numProcedures: patient.num_procedures ?? null,
    diag3: patient.diag_3 ?? '',
    a1cResult: patient.a1c_result ?? '',
    maxGluSerum: patient.max_glu_serum ?? '',
    insulinUsage: patient.insulin_usage ?? '',
...
export function buildPatientPayload(formState) {
  const payload = {
    ...
    number_inpatient: toNumber(formState.numberInpatient),
    number_emergency: toNumber(formState.numberEmergency),
    number_outpatient: toNumber(formState.numberOutpatient),
    num_procedures: toNumber(formState.numProcedures),
    diag_3: formState.diag3 || null,
    a1c_result: formState.a1cResult || null,
    max_glu_serum: formState.maxGluSerum || null,
    insulin_usage: formState.insulinUsage || null,
